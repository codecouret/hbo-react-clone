    ...
    return(
        <div className="featured-media">
            <iframe className="featured-media__video"
             width="100%" 
             height="100%" 
             src="https://www.youtube.com/embed/-BQPKD7eozY?autoplay=1&controls=0&loop=11&mute=1&enablejsapi=1&loop=1&start=16" 
        ...
        <div className="featured-media__bg">
            <div className="featured-media__container">
                ...
                <div className="featured-media__location">In theaters and on HBO MAX. Streaming thourghout May 23.</div>
